...
export default defineConfig({
      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          { text: 'Network Setup', items: [
            ...
            { text: 'Router Reservation', link: '/network/router-reservation' },
          ]},
    ...
    id: {
      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          { text: 'Setup Jaringan', items: [
            { text: 'Kenapa IP Penting', link: '/id/network/why-ip' },
            { text: 'IP Statis Windows', link: '/id/network/windows-static-ip' },
            { text: 'IP Statis Linux', link: '/id/network/linux-static-ip' },
            { text: 'Reservasi Router', link: '/id/network/router-reservation' },
          ]},
  ...
  themeConfig: {
    socialLinks: [{ icon: 'github', link: 'https://github.com/muhsalaa/kiddy-land' }]
  }
})

...
ReactDOM.createRoot(document.getElementById("root") as HTMLElement).render(<React.StrictMode><ClientProvider origin={origin}><LocaleProvider><ThemeProvider><HostDashboard source={source} origin={origin} onStop={stop} /></ThemeProvider></LocaleProvider></ClientProvider></React.StrictMode>);

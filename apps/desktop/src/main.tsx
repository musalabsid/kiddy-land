...
ReactDOM.createRoot(document.getElementById("root") as HTMLElement).render(<React.StrictMode><LocaleProvider><HostDashboard source={source} origin={origin} onStop={stop} /></LocaleProvider></React.StrictMode>);

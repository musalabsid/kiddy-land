...
import type { PaymentMethod, ProductLineInput, ProductRecord, TicketLineInput } from "../api/types";

export type CashierDraft = {
  packageId: string;
  ticketCount: number;
  member?: { id: string; childId: string; code: string; name: string; phone?: string; status?: "active" | "deactivated" };

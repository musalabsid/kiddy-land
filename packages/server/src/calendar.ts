...
export function createCalendarStore(initial?: { timezone?: string; database?: LocalDatabase }) {
  ...
  return { get timezone() { return timezone; }, weekly, overrides, packages, audit, setTimezone, setWeeklyHours, setOverride, effectiveSchedule, operatingDate, operatingTime, canOperate, upsertPackage, configure, snapshot };
}

...
} from "@workspace/ui/components/notification-alerts";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export function AppShell({ children }: { children: ReactNode }) {
    ...
    pathname === "/"
      ...
      : pathname === "/sales"
        ...
        : pathname === "/sales-history"
          ...
          : pathname === "/members"
            ? "app.members"
            : pathname === "/inventory" || pathname === "/owner/inventory"
              ? "app.inventory"
              : pathname === "/scanner"
                ? "app.scanner"
                : pathname === "/kiosk"
                  ? "app.kiosk"
                  : pathname === "/owner/devices"
                    ? "app.devices"
                    : pathname === "/owner/calendar"
                      ? "app.calendar"
                      : pathname === "/owner/packages"
                        ? "app.packages"
                        : pathname === "/owner/catalog"
                          ? "app.catalog"
                          : pathname === "/owner/memberships"
                            ? "app.memberships"
                            : pathname === "/owner/membership-discounts"
                              ? "app.membershipDiscounts"
                              : pathname === "/owner/reports"
                                ? "app.reports"
                                : pathname === "/owner/backups"
                                  ? "app.backups"
                                  : pathname === "/owner/customization" ||
  ...
  const showOperational =
    mode === "Cashier" || mode === "Scanner" || mode === "Public Kiosk";
  const showOverview =
    mode !== "Public Kiosk" &&
    ...
    <SidebarProvider>
      <Sidebar collapsible="icon">
        <SidebarHeader className="flex flex-row items-center gap-2 px-4 py-3">
          {venue.data?.logoUrl ? (
            <img
              src={venue.data.logoUrl}
              alt={venue.data.venueName}
              className="size-7 shrink-0 rounded border object-cover group-data-[collapsible=icon]:size-5"
            />
          ) : (
                ...
                <SidebarMenu>
                  {mode === "Cashier" && (
                    <>
                      ...
                      <SidebarMenuItem>
                        <SidebarMenuButton
                          render={<Link to="/sales-history" />}
                          isActive={active("/sales-history")}
                        >
                          <History />
                          {t("app.salesHistory")}
                        </SidebarMenuButton>
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/devices" />}
                      isActive={active("/owner/devices")}
                    >
                      <Settings2 />
                      {t("app.devices")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/calendar" />}
                      isActive={active("/owner/calendar")}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/packages" />}
                      isActive={active("/owner/packages")}
                    >
                      <PackageCheck />
                      {t("app.packages")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/catalog" />}
                      isActive={active("/owner/catalog")}
                    >
                      <Tags />
                      {t("app.catalog")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/inventory" />}
                      isActive={active("/owner/inventory")}
                    >
                      <PackageIcon />
                      {t("app.inventory")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/reports" />}
                      isActive={active("/owner/reports")}
                    >
                      <BarChart3 />
                      {t("app.reports")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/backups" />}
                      isActive={active("/owner/backups")}
                    >
                      <HardDrive />
                      {t("app.backups")}
                    </SidebarMenuButton>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      render={<Link to="/owner/settings" />}
                      isActive={
                        active("/owner/settings") ||
                        active("/owner/customization")
                      }
                    >
                      <Palette />

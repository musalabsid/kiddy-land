...
export function ReportsDashboard() {
  ...
  return <div className="w-full max-w-6xl px-5 py-8 sm:px-8"><header className="flex flex-wrap items-end justify-between gap-4 mb-4">
    ...
    <section className="grid gap-4"><Card><CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-base"><CalendarDays className="size-5 text-foreground dark:!text-white" />{t("reports.dateRange")}</CardTitle><CardDescription>{t("reports.exportsHint")}</CardDescription></CardHeader><CardContent className="grid gap-4">
